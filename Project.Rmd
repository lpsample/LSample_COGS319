...
getRightIR<- function(obsGrid){
  ...
  if(cardinal== up){ 
    if(obsGrid[aCur+up]==1){
      ...
      rightIR<- (mean(obsGrid[aCur], obsGrid[aCur+cardinal], obsGrid[aCur+right], obsGrid[aCur+up+right]))
    if(obsGrid[aCur]||
       obsGrid[aCur+cardinal]|| 
       obsGrid[aCur+left]|| 
       obsGrid[aCur+up+left] == 1){
      leftIR<- (mean(obsGrid[aCur], obsGrid[aCur+cardinal], obsGrid[aCur+left], obsGrid[aCur+up+left]))
    
    #need to do the rest if this is correct
